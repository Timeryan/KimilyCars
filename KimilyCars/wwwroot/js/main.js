   ...
   /*----------------------------------------------------*/
	...
	function convertFormToJSON(form) {
        ...
        $.each(array, function () {
			...
			if(this.name === 'contactEmail'){
				json['email'] = this.value;
			}
			if(this.name === 'contactPhone'){
				json['phone'] = this.value;
			}
			if(this.name === 'contactMessage'){
				json['description'] = this.value;
			}
	...
	$('#contactForm').validate({
		...
		submitHandler: function(form) {
			...
			$.ajax({      	
		      ...
		      url: "https://45.141.77.232/api/telegram/send",
